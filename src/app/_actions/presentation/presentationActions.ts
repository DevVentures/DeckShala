...
export async function createPresentation({
  ...
  try {
      ...
      data: {
        ...
        presentation: {
          create: {
            ...
            aiGenerationMode: templateCategory?.toLowerCase().replace("_", "-"),
          },
        },
      },
      include: {
    ...
    logger.error("Failed to create presentation", error as Error, { userId });
    return {
      success: false,
...
export async function updatePresentation({
  ...
  try {
    ...
    logger.error("Failed to update presentation", error as Error, { id });
    return {
      success: false,
...
export async function updatePresentationTitle(id: string, title: string) {
  ...
  try {
    ...
    logger.error("Failed to update presentation title", error as Error, { id, title });
    return {
      success: false,
...
export async function deletePresentations(ids: string[]) {
  ...
  try {
    ...
    logger.error("Failed to delete presentations", error as Error, { ids, count: ids.length });
    return {
      success: false,
...
export async function getPresentation(id: string) {
  ...
  try {
    ...
    logger.error("Failed to fetch presentation", error as Error, { id });
    return {
      success: false,
...
export async function getPresentationContent(id: string) {
  ...
  try {
    ...
    logger.error("Failed to fetch presentation content", error as Error, { id });
    return {
      success: false,
      message: "Failed to fetch presentation",
    };
...
export async function updatePresentationTheme(id: string, theme: string) {
  ...
  try {
    ...
    logger.error("Failed to update presentation theme", error as Error, { id, theme });
    return {
      success: false,
...
export async function duplicatePresentation(id: string, newTitle?: string) {
  ...
  try {
    ...
    logger.error("Failed to duplicate presentation", error as Error, { id, newTitle });
    return {
      success: false,
