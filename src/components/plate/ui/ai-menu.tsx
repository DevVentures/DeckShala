...
Start writing a new paragraph AFTER <Document> ONLY ONE SENTENCE`
  ...
  rephrase: {
    ...
    onSelect: ({ editor }) => {
      void editor.getApi(AIChatPlugin).aiChat.submit({
        prompt: "Rephrase this content to be more clear and engaging",
      });
    },
  },
  improveStructure: {
    ...
    value: "improveStructure",
    onSelect: ({ editor }) => {
      void editor.getApi(AIChatPlugin).aiChat.submit({
        prompt: "Improve the structure and organization of this content",
      });
    },
  },
  tryAgain: {
  ...
  selectionCommand: [
    {
      items: [
        ...
        aiChatItems.rephrase,
        aiChatItems.improveStructure,
        aiChatItems.emojify,
