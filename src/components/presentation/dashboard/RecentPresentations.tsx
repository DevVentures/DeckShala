        ...
        {presentations.slice(0, 3).map((presentation) => (
          ...
          >
            ...
            >
              ...
              {presentation.presentation?.templateCategory && (
                <Badge
                  variant="secondary"
                  className="absolute left-2 top-2 gap-1 bg-background/90 backdrop-blur-sm"
                >
                  <Sparkles className="h-3 w-3" />
                  {TemplateService.getIndustryTemplates().find(
                    (t) =>
                      t.category ===
                      presentation.presentation?.templateCategory,
                  )?.displayName || presentation.presentation.templateCategory}
                </Badge>
              )}
            </div>
