...
import { CollaborativeCursors } from "@/components/presentation/collaboration/CollaborativeCursors";
    ...
    >
      <SortableContext items={items} strategy={verticalListSortingStrategy}>
        ...
        <PlateController>
          ...
          {/* Collaborative cursors overlay - Only show when not presenting */}
          {!isPresenting && (
