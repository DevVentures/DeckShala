  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-md bg-muted/50 py-3 text-muted-foreground transition-all hover:bg-primary/10 hover:text-primary hover:shadow-sm disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
        aria-label="Add new card to outline"
        title="Add a new topic to your presentation"
      >
        <Plus size={20} />
        <span className="font-medium">Add Slide Topic</span>
      </button>
