# Contributing to DeckShala

Thank you for your interest in contributing to DeckShala! This document provides guidelines and instructions for contributing to this project.
...
1. Check if it already exists in the [Issues](https://github.com/DevVentures/DeckShala/issues)
...
- Reach out via the project's communication channels ([Discord](https://discord.gg/fsMHMhAHRV) / [Issues](https://github.com/DevVentures/DeckShala/issues))

## License

By contributing to this project, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).

Thank you for contributing to make DeckShala better for everyone!
